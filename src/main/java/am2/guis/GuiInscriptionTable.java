...
public class GuiInscriptionTable extends GuiContainer{
	...
	public void initGui(){
		...
		if (usingPlayer.capabilities.isCreativeMode || AMCore.instance.config.SurvivalModeMakeSpellButton()){
	...
	protected void actionPerformed(GuiButton par1GuiButton){
		if (par1GuiButton == createSpellButton && (usingPlayer.capabilities.isCreativeMode || isSpellFree())){
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2){
		...
		if (result.valid){
            ...
            // Added by Alex:
            if (usingPlayer.capabilities.isCreativeMode || isSpellFree()){
    ...
    // Added by Alex
    public boolean isSpellFree() {
        if (!AMCore.instance.config.SurvivalModeMakeSpellButton()) {
            return false;
        }
        
        int numOfSpellParts = ((ContainerInscriptionTable)this.inventorySlots).getTable().getNumOfSpellParts();
        // System.out.print("Number of Spell Parts: ");
        // System.out.println(numOfSpellParts);
        
        int playerLevel = ExtendedProperties.For(usingPlayer).getMagicLevel();
        // System.out.print("Player Magic Level: ");
        // System.out.println(playerLevel);
        
        
        // Yes, yes, I know it's hard coded. I'll make this configurable once I know it's working.
        if (playerLevel < 10){
            return false;
        } 
        
        int maxFreeSpellParts = ((playerLevel + AMCore.instance.config.SurvivalModeMakeSpellButton_StartingLevel()) / AMCore.instance.config.SurvivalModeMakeSpellButton_Increment()) + (AMCore.instance.config.SurvivalModeMakeSpellButton_StartingParts() - 1);
        
        // System.out.print("Max Free Spell Parts: ");
        // System.out.println(maxFreeSpellParts);
        
        if (maxFreeSpellParts < numOfSpellParts) {
            return false;
        }
