...
public class BlockBrokenPowerLink extends BlockContainer{
	...
	public void setBlockBoundsBasedOnState(IBlockAccess par1iBlockAccess, int par2, int par3, int par4){
		...
		if (player != null){
			if ((par2 == 0 && par3 == 0 && par4 == 0) || player.getCurrentArmor(3) != null && player.getCurrentArmor(3).getItem() instanceof IShowMagitechInfo){
	...
	public AxisAlignedBB getSelectedBoundingBoxFromPool(World par1World, int par2, int par3, int par4){
		...
		if (localPlayer != null){
			if (localPlayer.getCurrentArmor(3) != null && localPlayer.getCurrentArmor(3).getItem() instanceof IShowMagitechInfo){
