...
public class AMConfig extends Configuration{
    // Added by Alex:
	private final String KEY_SurvivalModeMakeSpellButton = "SurvivalModeMakeSpellButton";
	private final String KEY_SurvivalModeMakeSpellButton_StartingLevel = "SurvivalModeMakeSpellButton_StartingLevel";
	private final String KEY_SurvivalModeMakeSpellButton_StartingParts = "SurvivalModeMakeSpellButton_StartingParts";
	private final String KEY_SurvivalModeMakeSpellButton_Increment = "SurvivalModeMakeSpellButton_Increment";
	// End of Addition.
    ...
    // Added by Alex:
	private boolean SurvivalModeMakeSpellButton;
	private int SurvivalModeMakeSpellButton_StartingLevel;
	private int SurvivalModeMakeSpellButton_StartingParts;
	private int SurvivalModeMakeSpellButton_Increment;
    // End of Addition.
    ...
    // Added by Alex:
	public boolean SurvivalModeMakeSpellButton(){
		return SurvivalModeMakeSpellButton;
	}
    public int SurvivalModeMakeSpellButton_StartingLevel(){
		return SurvivalModeMakeSpellButton_StartingLevel;
	}
    public int SurvivalModeMakeSpellButton_StartingParts(){
		return SurvivalModeMakeSpellButton_StartingParts;
	}
    public int SurvivalModeMakeSpellButton_Increment(){
		return SurvivalModeMakeSpellButton_Increment;
	}
